public class Parameters {
    ...
    public static final int NUM_OF_PEOPLE = 200;
    ...
    public static final int NUM_OF_TICKS = 50;
    ...
    public static final boolean WEALTH_INHERITANCE = true;
    ...
    public static final double TAX_RATE_POOR = 0.1;
    public static final double TAX_RATE_MIDDLE = 0.2;
